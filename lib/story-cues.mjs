...
export const storyCues = [
  ...
  { id: 'experience', start: 9.2, end: 10.25, anchor: 9.8, fade: 0.16 },
  { id: 'contact', start: 10.25, end: 343 / 24, anchor: 11.5, fade: 0.25, hold: true },
];
...
export function sceneAtTime(time) {
  ...
  return { id: cue.id, opacity, offset: 28 - progress * 56 };
}
