...
test('overlays match papers, graduation, and laptop frames in either direction', () => {
  const samples = [
    ...
    [7.1, null], [8.15, 'education'], [9.05, null], [9.7, 'experience'], [10.24, 'experience'], [10.5, 'contact'], [14.25, 'contact'],
  ];
  ...
  assert.equal(sceneAtTime(10.25).id, 'contact', 'v6 switches from work to contact');
